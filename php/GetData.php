...
*select *
*from (
 *   select spec_meals.specific_meal_name, 
  *  	spec_meals.generic_meal_name, 
  *  	ingredient_name, 
   * 	grams_needed
	*from 
*		specific_meals spec_meals
*	join
*		specific_meal_ingredients spec_meals_ing on spec_meals.specific_meal_name = spec_meals_ing.specific_meal_name
*	where
*	 	spec_meals.specific_meal_name = 'Specific Meal 1'
*	) meal 
 *   join (
  *  	select *
 *		from products
 *)ing on meal.ingredient_name = ing.ingredient_name
*/